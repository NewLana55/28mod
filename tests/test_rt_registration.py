...
@allure.story('Тесты Регистрации')
class TestValidRegistrationRT:
    ...
    def open(self):
        self.driver = webdriver.Chrome('\Users\Notik\PycharmProjects\26\chromedriver_win32/')
...
# python -m pytest --verbose test_rt_authorization.py *--alluredir reports*
